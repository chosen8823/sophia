...
try:
    ...
    print("Warning: n8n integration not available, using mock")
    class MockN8nManager:
        def list_workflows(self): return []
        def get_workflow_status(self, wf_id): return {"status": "unknown"}
        def execute_workflow(self, wf_id, data): return {"result": "mock"}
    n8n_manager = MockN8nManager()
